...
//import image from "/Screenshot 2025-07-03 191501.png"; // Adjust the path as necessary
const Navigation = () => {
  return (
    <nav className="flex items-center justify-between p-3 bg-slate-900/80 backdrop-blur-sm fixed w-full top-0 z-50 border-b border-slate-700/50">
      <div className="flex items-center space-x-2">
        <div className="w-6 h-6 bg-gradient-to-r from-blue-500 to-green-500 rounded-lg shadow-lg shadow-blue-500/30"></div>
